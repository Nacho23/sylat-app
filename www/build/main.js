...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mock_nav__ = __webpack_require__(469);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_navSelector__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__listQuestions_list_question__ = __webpack_require__(278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_user_user__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_app_storage_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__question_question__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__profile_profile__ = __webpack_require__(281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__contact_contact__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__godson_list_godson_list__ = __webpack_require__(284);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.viewDetail = function (id) {
        if (id == 1) {
            ...
            this.nav.push(__WEBPACK_IMPORTED_MODULE_3__listQuestions_list_question__["a" /* ListQuestionPage */], { id: id });
        }
        else if (id == 3) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_app_storage_service__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PostProvider = /** @class */ (function () {
    function PostProvider(http, store) {
        var _this = this;
        this.http = http;
        this.store = store;
    ...
    PostProvider.prototype.getCategoryCollection = function (query) {
        var params = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["d" /* HttpParams */]().set('unit_id', query.unit_id);
        ...
        return this.http.get(this.api + '/category', { params: params, reportProgress: true, observe: 'events', headers: headers }).pipe();
    };
    PostProvider.prototype.getPostCollection = function (unit_id, query) {
        var params = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["d" /* HttpParams */]().set('user_id', query.user_id).set('rol_id', query.rol_id);
        var headers = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpHeaders */]().set('Content-Type', 'application/json').set('x-access-token', this.token);
        return this.http.get(this.api + ("/unit/" + unit_id + "/post"), { params: params, reportProgress: true, observe: 'events', headers: headers }).pipe();
    };
    PostProvider.prototype.postPostCollection = function (title, body, category, is_important, unit_uuid, user_sender_id, user_receiver_id) {
        var params = { title: title, body: body, category_id: category, is_important: is_important, user_sender_id: user_sender_id, user_receiver_id: user_receiver_id };
        var headers = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpHeaders */]().set('Content-Type', 'application/json').set('x-access-token', this.token);
        return this.http.post(this.api + ("/unit/" + unit_uuid + "/post"), params, { reportProgress: true, observe: 'events', headers: headers }).pipe();
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ListQuestionPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_app_storage_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_question_question__ = __webpack_require__(90);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ListQuestionPage = /** @class */ (function () {
    function ListQuestionPage(nav, store, questionProvider) {
        this.nav = nav;
        this.store = store;
    ...
    ListQuestionPage.prototype.fillQuestion = function () {
        var _this = this;
        this.store.get('unit_id').then(function (unit_id) {
            _this.questionProvider.getQuestionCollection(unit_id).subscribe(function (event) {
                if (event.body) {
                    _this.questionList = event.body.data.questions;
                }
            });
        });
    };
    ListQuestionPage.prototype.setType = function (type) {
        if (type == 'brief') {
    ...
    ListQuestionPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-list-question',template:/*ion-inline-start:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/listQuestions/list-question.html"*/'<!-- -->\n<ion-header>\n\n  <ion-navbar  color="primary">\n    <ion-title>\n      <span ion-text>Preguntas realizadas</span>\n    </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content class="common-bg">\n  <ion-list>\n    <ion-item *ngFor="let question of questionList">\n        <small class="pull-right" style="color: gray">{{question.created_at}}</small>\n        <p>{{question.description}}</p>\n        <small>{{setType(question.type)}}</small>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/listQuestions/list-question.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__services_app_storage_service__["a" /* AppStorageService */],
            __WEBPACK_IMPORTED_MODULE_3__providers_question_question__["a" /* QuestionProvider */]])
    ], ListQuestionPage);
    return ListQuestionPage;
}());

//# sourceMappingURL=list-question.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_app_storage_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_question_question__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__question_details_question_details__ = __webpack_require__(280);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QuestionPage = /** @class */ (function () {
    function QuestionPage(navCtrl, navParams, store, questionProvider, toastCtrl) {
    ...
    QuestionPage.prototype.fillQuestion = function () {
        var _this = this;
        this.store.get('unit_id').then(function (unit_id) {
            _this.questionProvider.getQuestionCollection(unit_id).subscribe(function (event) {
                if (event.body) {
    ...
    QuestionPage.prototype.fillAnswer = function () {
        var _this = this;
        this.store.get('user_id').then(function (user_id) {
            _this.questionProvider.getAnswerCollection({ user_id: user_id }).subscribe(function (event) {
                if (event.body) {
                    _this.answerList = event.body.data.answer;
                }
            });
        });
    };
    QuestionPage.prototype.setType = function (type) {
        if (type == 'brief') {
            return 'Pregunta corta';
        }
        else if (type == 'paragraph') {
    ...
    QuestionPage.prototype.answerQuestion = function (question_id) {
        var _this = this;
        ...
        this.questionProvider.getAnswerResource(question_id).subscribe(function (event) {
            if (event.body) {
                _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__question_details_question_details__["a" /* QuestionDetailsPage */], {
    ...
    QuestionPage.prototype.questionAnswered = function (question_id) {
        for (var i = 0; i < this.answerList.length; i++) {
            if (question_id == this.answerList[i].question_id) {
                return true;
            }
    ...
    QuestionPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-question',template:/*ion-inline-start:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/question/question.html"*/'<!--\n  Generated template for the QuestionPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar  color="primary">\n    <ion-title>\n      <span ion-text>Preguntas realizadas</span>\n    </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n  <ion-list>\n    <ion-item *ngFor="let question of questionList"  [ngStyle]="{\'background\': questionAnswered(question.id) ? \'rgba(63, 191, 63, 0.1)\' : \'rgba(191, 63, 63, 0.1)\'}">\n        <ion-button (click)="answerQuestion(question.id)">\n          <small class="pull-right" style="color: gray">{{question.created_at}}</small>\n          <p>{{question.description}}</p>\n          <small>{{setType(question.type)}}</small>\n        </ion-button>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/question/question.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__services_app_storage_service__["a" /* AppStorageService */], __WEBPACK_IMPORTED_MODULE_3__providers_question_question__["a" /* QuestionProvider */],
...
var QuestionDetailsPage = /** @class */ (function () {
    function QuestionDetailsPage(navCtrl, navParams, store, questionProvider, toastCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.store = store;
        this.questionProvider = questionProvider;
    ...
    QuestionDetailsPage.prototype.setOptions = function () {
        if (this.currentQuestion && (this.currentQuestion.type == 'multiple_choice' || this.currentQuestion.type == "checkbox")) {
            ...
            var stepsArray = [];
            var objAux = { min: '', max: '', min_text: '', max_text: '' };
            ...
            for (var i = parseInt(objAux['min']) + 1; i < parseInt(objAux['max']); i++) {
                var objAux2 = {};
                objAux2 = { value: i };
    ...
    QuestionDetailsPage.prototype.saveRequest = function (request) {
        var _this = this;
        console.log(this.store);
        this.store.get('user_id').then(function (user_id) {
            console.log('USER', user_id);
            _this.questionProvider.postAnswerCollection(user_id, {
                type: _this.currentQuestion.type,
                answer: request,
                question_id: _this.currentQuestion.id
    ...
    QuestionDetailsPage.prototype.saveRequestCheckbox = function () {
        console.log('ARREGLO', this.answeredCheckboxQuestion);
        console.log('question', this.currentQuestion);
    };
    QuestionDetailsPage.prototype.selectOption = function (option) {
        console.log('opt', option);
        if (option.isChecked) {
            this.answeredCheckboxQuestion.push(option.value);
        }
        else if (!option.isChecked) {
            var position = this.answeredCheckboxQuestion.indexOf(option.value);
            if (position !== -1) {
    ...
    QuestionDetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-question-details',template:/*ion-inline-start:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/question-details/question-details.html"*/'<!--\n  Generated template for the QuestionDetailsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar  color="primary">\n    <ion-title>\n      <span ion-text>Preguntas</span>\n    </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n  <div *ngIf="questionType == \'brief\'">\n    <ng-container *ngTemplateOutlet="brief"></ng-container>\n  </div>\n  <div *ngIf="questionType == \'paragraph\'">\n    <ng-container *ngTemplateOutlet="paragraph"></ng-container>\n  </div>\n  <div *ngIf="questionType == \'multiple_choice\'">\n    <ng-container *ngTemplateOutlet="multiple_choice"></ng-container>\n  </div>\n  <div *ngIf="questionType == \'checkbox\'">\n    <ng-container *ngTemplateOutlet="checkbox"></ng-container>\n  </div>\n  <div *ngIf="questionType == \'scale\'">\n    <ng-container *ngTemplateOutlet="scale"></ng-container>\n  </div>\n</ion-content>\n\n<ng-template #brief>\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <ion-item>\n        <small style="color: gray">{{currentQuestion ? currentQuestion.created_at : \'\'}}</small><br>\n        {{currentQuestion ? currentQuestion.description : \'\'}}\n      </ion-item>\n    </div>\n  </div>\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <ion-item>\n        <ion-input type="text" placeholder="Respuesta aquí" [(ngModel)]="request"></ion-input>\n      </ion-item>\n    </div>\n  </div>\n  <button ion-button icon-start block color="dark" tappable (click)="saveRequest(request)">\n    Guardar\n  </button>\n</ng-template>\n<ng-template #paragraph>\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <ion-item>\n        <small style="color: gray">{{currentQuestion ? currentQuestion.created_at : \'\'}}</small><br>\n        {{currentQuestion ? currentQuestion.description : \'\'}}\n      </ion-item>\n    </div>\n  </div>\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <ion-item>\n        <ion-textarea placeholder="Escribe tu respuesta aquí" rows="4" [(ngModel)]="request"></ion-textarea>\n      </ion-item>\n    </div>\n  </div>\n  <button ion-button icon-start block color="dark" tappable (click)="saveRequest(request)">\n    Guardar\n  </button>\n</ng-template>\n<ng-template #multiple_choice>\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <ion-item>\n        <small style="color: gray">{{currentQuestion ? currentQuestion.created_at : \'\'}}</small><br>\n        {{currentQuestion ? currentQuestion.description : \'\'}}\n      </ion-item>\n    </div>\n  </div>\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <ion-item>\n        <ion-select placeholder="Seleccione respuesta" [(ngModel)]="request">\n          <ion-option *ngFor="let option of optionsQuestion" value="{{option.value}}">{{option.value}}</ion-option>\n        </ion-select>\n      </ion-item>\n    </div>\n  </div>\n  <button ion-button icon-start block color="dark" tappable (click)="saveRequest(request)">\n    Guardar\n  </button>\n</ng-template>\n<ng-template #checkbox>\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <ion-item>\n        <small style="color: gray">{{currentQuestion ? currentQuestion.created_at : \'\'}}</small><br>\n        {{currentQuestion ? currentQuestion.description : \'\'}}\n      </ion-item>\n    </div>\n  </div>\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <ion-item *ngFor="let option of optionsQuestion">\n        <ion-label>{{option.value}}</ion-label>\n        <ion-checkbox slot="end" [(ngModel)]="option.isChecked" (click)="selectOption(option)"></ion-checkbox>\n      </ion-item>\n    </div>\n  </div>\n  <button ion-button icon-start block color="dark" tappable (click)="saveRequestCheckbox()">\n    Guardar\n  </button>\n</ng-template>\n<ng-template #scale>\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <ion-item>\n        <small style="color: gray">{{currentQuestion ? currentQuestion.created_at : \'\'}}</small><br>\n        {{currentQuestion ? currentQuestion.description : \'\'}}\n      </ion-item>\n    </div>\n  </div>\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding style="padding-bottom: 80px">\n        <!--<ng5-slider [(ngModel)]="scaleValue" [options]="options"></ng5-slider>-->\n    </div>\n  </div>\n  <button ion-button icon-start block color="dark" tappable (click)="saveRequest(scaleValue)">\n    Guardar\n  </button>\n</ng-template>\n<ng-template #loading>\n    <div>Cargando...</div>\n</ng-template>\n'/*ion-inline-end:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/question-details/question-details.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__services_app_storage_service__["a" /* AppStorageService */], __WEBPACK_IMPORTED_MODULE_3__providers_question_question__["a" /* QuestionProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ToastController */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_app_storage_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_user_user__ = __webpack_require__(51);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_common_common__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_user_user__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_app_storage_service__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var ContactPage = /** @class */ (function () {
    ...
    ContactPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__services_app_storage_service__["a" /* AppStorageService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ToastController */]])
    ], ContactPage);
    return ContactPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_app_storage_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_user_user__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__godson_details_godson_details__ = __webpack_require__(285);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GodsonListPage = /** @class */ (function () {
    ...
    GodsonListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-godson-list',template:/*ion-inline-start:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/godson-list/godson-list.html"*/'<!-- -->\n<ion-header>\n\n  <ion-navbar  color="primary">\n    <ion-title>\n      <span ion-text>Lista de ahijados/as</span>\n    </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content class="common-bg">\n  <!--booking form-->\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n\n      <ion-list>\n        <ion-item *ngFor="let item of godsonList">\n          <ion-button (click)="openUserDetals(item.uuid)">\n            <p>{{item.first_name + \' \' + item.last_name}}</p>\n            <small>{{item.rut + \'-\' + item.rut_dv}}</small>\n          </ion-button>\n        </ion-item>\n      </ion-list>\n\n    </div>\n  </div>\n</ion-content>'/*ion-inline-end:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/godson-list/godson-list.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__services_app_storage_service__["a" /* AppStorageService */], __WEBPACK_IMPORTED_MODULE_3__providers_user_user__["a" /* UserProvider */]])
    ], GodsonListPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_post_post__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_app_storage_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__history_history__ = __webpack_require__(286);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GodsonDetailsPage = /** @class */ (function () {
    function GodsonDetailsPage(navCtrl, navParams, postProvider, store) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    GodsonDetailsPage.prototype.ionViewWillEnter = function () {
        this.getHistories();
    };
    GodsonDetailsPage.prototype.getHistories = function () {
        var _this = this;
        this.store.get('unit_id').then(function (unit_id) {
            var query = { user_id: _this.currentUser.id, rol_id: _this.currentUser.rol_id };
            _this.postProvider.getPostCollection(unit_id, query).subscribe(function (event) {
                if (event.body) {
                    _this.postList = event.body.data.posts;
                }
            });
        });
    };
    GodsonDetailsPage.prototype.generateHistory = function (type) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__history_history__["a" /* HistoryPage */], {
            user: this.currentUser,
            type: type
        });
    };
    GodsonDetailsPage.prototype.openUserDetals = function (uuid) {
        console.log('POST TO OPEN', uuid);
    };
    GodsonDetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-godson-details',template:/*ion-inline-start:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/godson-details/godson-details.html"*/'<!-- -->\n<ion-header>\n\n  <ion-navbar  color="primary">\n    <ion-title>\n      <span ion-text>Datos de {{currentUser.first_name + \' \' + currentUser.last_name}}</span>\n    </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content class="common-bg">\n  <!--booking form-->\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n\n      <ion-list>\n        <ion-item>\n          <div class="row">\n            <div class="col">\n              <p><strong>Nombre</strong></p>\n            </div>\n            <div class="col">\n              <p class="float-rigth">{{currentUser.first_name + \' \' + currentUser.last_name}}</p>\n            </div>\n          </div>\n          <div class="row">\n            <div class="col">\n              <p><strong>Correo electrónico</strong></p>\n            </div>\n            <div class="col">\n              <p class="float-rigth">{{currentUser.email}}</p>\n            </div>\n          </div>\n          <div class="row">\n            <div class="col">\n              <p><strong>Teléfono</strong></p>\n            </div>\n            <div class="col">\n              <p class="float-rigth">{{currentUser.phone_mobile}}</p>\n            </div>\n          </div>\n        </ion-item>\n      </ion-list>\n    </div>\n  </div>\n  <ion-row>\n    <ion-col size="5" style="margin-left: 10px;">\n      <button ion-button class="pull-right btn-block btn-sm" color="success" tappable (click)="generateHistory(0)">\n        Estándar\n      </button>\n    </ion-col>\n    <ion-col size="5" style="margin-right: 10px;">\n      <button ion-button class="btn-block btn-sm" color="danger" tappable (click)="generateHistory(1)">\n        Urgente\n      </button>\n    </ion-col>\n  </ion-row>\n  <div class="row">\n    <div class="col">\n      <h6>Historias</h6>\n    </div>\n  </div>\n  <div class="booking-form card round" margin *ngFor="let post of postList">\n    <div class="border-bottom" padding>\n      <ion-list>\n        <ion-item>\n            <ion-button (click)="openUserDetals(post.uuid)">\n              <small class="pull-right" style="color: gray">{{post.created_at}}</small>\n              <p>{{post.title}}</p>\n              <small>{{post.body}}</small>\n          </ion-button>\n        </ion-item>\n      </ion-list>\n    </div>\n  </div>\n</ion-content>'/*ion-inline-end:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/godson-details/godson-details.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_post_post__["a" /* PostProvider */], __WEBPACK_IMPORTED_MODULE_3__services_app_storage_service__["a" /* AppStorageService */]])
    ], GodsonDetailsPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_user_user__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_app_storage_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_post_post__ = __webpack_require__(156);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HistoryPage = /** @class */ (function () {
    ...
    function HistoryPage(navCtrl, navParams, userProvider, store, postProvider, toastCtrl) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.userProvider = userProvider;
    ...
    HistoryPage.prototype.fillCategory = function () {
        var _this = this;
        var unit_id = this.currentUser.unit.id;
        this.postProvider.getCategoryCollection({ unit_id: unit_id }).subscribe(function (event) {
            if (event.body) {
                _this.categoryList = event.body.data.categories;
            }
        });
    };
    HistoryPage.prototype.generate = function (title, category, body) {
        var _this = this;
        var user_sender_id = (this.currentUser.id).toString();
        var user_receiver_id = (this.targetUser.id).toString();
        var unit_uuid = this.currentUser.unit.uuid;
        var is_important = this.typeHistory;
        this.postProvider.postPostCollection(title, body, category, is_important, unit_uuid, user_sender_id, user_receiver_id).subscribe(function (event) {
            if (event.body) {
                _this.title = '';
                _this.body = '';
                var toast = _this.toastCtrl.create({
    ...
    HistoryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-history',template:/*ion-inline-start:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/history/history.html"*/'<!-- -->\n<ion-header>\n\n  <ion-navbar  color="primary">\n    <ion-title>\n      <span ion-text>Generar historia</span>\n    </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content class="common-bg">\n  <!--booking form-->\n  <div class="booking-form card round" margin>\n    <div class="border-bottom" padding>\n      <h5>Generar historia</h5>\n\n      <!--choose guest-->\n      <ion-grid class="filters" no-padding margin-top>\n        <ion-row>\n          <ion-col class="adult" width-70>\n            <ion-item>\n              <ion-label floating>\n                <ion-icon name="text" item-start class="text-primary"></ion-icon>\n                Título\n              </ion-label>\n              <ion-input type="text" [(ngModel)]=\'title\'></ion-input>\n            </ion-item>\n          </ion-col>\n        </ion-row>\n        <ion-row>\n          <ion-col class="adult" width-70>\n            <ion-item>\n              <ion-label>\n                <ion-icon name="bookmark" item-start class="text-primary"></ion-icon>\n                Categoría\n              </ion-label>\n              <ion-select [(ngModel)]="category" submitText="Seleccionar" cancelText="Cancelar">\n                <ion-option value="{{category.id}}" *ngFor="let category of categoryList">{{category.name}}</ion-option>\n              </ion-select>\n            </ion-item>\n          </ion-col>\n        </ion-row>\n        <ion-row margin-top>\n          <ion-col width-70>\n            <ion-item>\n              <ion-label floating>\n                <ion-icon name="text" item-start class="text-primary"></ion-icon>\n                Mensaje</ion-label>\n              <ion-textarea [(ngModel)]=\'body\'></ion-textarea>\n            </ion-item>\n          </ion-col>\n        </ion-row>\n      </ion-grid>\n    </div>\n    <div padding class="form-bottom">\n      <button ion-button class="pull-right btn-block" color="secondary" tappable (click)="generate(title, category, body)">{{titleButton}}\n      </button>\n      <div class="clear"></div>\n    </div>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/mnt/c/Users/56965/Documents/proyectos/sylat/sylat-app/src/pages/history/history.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_user_user__["a" /* UserProvider */], __WEBPACK_IMPORTED_MODULE_3__services_app_storage_service__["a" /* AppStorageService */],
            __WEBPACK_IMPORTED_MODULE_4__providers_post_post__["a" /* PostProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ToastController */]])
    ], HistoryPage);
    return HistoryPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_http__ = __webpack_require__(459);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_activity_service__ = __webpack_require__(467);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_navSelector__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_weather__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_app_storage_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__app_component__ = __webpack_require__(471);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_settings_settings__ = __webpack_require__(472);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_checkout_trip_checkout_trip__ = __webpack_require__(473);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_home_home__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_login_login__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_question_question__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_profile_profile__ = __webpack_require__(281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_contact_contact__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_godson_list_godson_list__ = __webpack_require__(284);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_godson_details_godson_details__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_notifications_notifications__ = __webpack_require__(474);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_history_history__ = __webpack_require__(286);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_register_register__ = __webpack_require__(287);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_question_details_question_details__ = __webpack_require__(280);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_search_location_search_location__ = __webpack_require__(475);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_listQuestions_list_question__ = __webpack_require__(278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_trips_trips__ = __webpack_require__(476);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_local_weather_local_weather__ = __webpack_require__(477);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__providers_auth_auth__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__providers_user_user__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__providers_common_common__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__providers_post_post__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__providers_question_question__ = __webpack_require__(90);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_30__pages_local_weather_local_weather__["a" /* LocalWeatherPage */],
                ...
                __WEBPACK_IMPORTED_MODULE_26__pages_question_details_question_details__["a" /* QuestionDetailsPage */],
                __WEBPACK_IMPORTED_MODULE_27__pages_search_location_search_location__["a" /* SearchLocationPage */],
                __WEBPACK_IMPORTED_MODULE_28__pages_listQuestions_list_question__["a" /* ListQuestionPage */],
                __WEBPACK_IMPORTED_MODULE_29__pages_trips_trips__["a" /* TripsPage */]
            ],
            imports: [
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_33__providers_common_common__["a" /* CommonProvider */],
                __WEBPACK_IMPORTED_MODULE_34__providers_post_post__["a" /* PostProvider */],
                __WEBPACK_IMPORTED_MODULE_35__providers_question_question__["a" /* QuestionProvider */],
            ],
            schemas: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mock_activities__ = __webpack_require__(468);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_weather__ = __webpack_require__(277);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_auth_auth__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_app_storage_service__ = __webpack_require__(17);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QuestionProvider = /** @class */ (function () {
    function QuestionProvider(http, store) {
        var _this = this;
        this.http = http;
        this.store = store;
        this.api = __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].urlApi;
    ...
    QuestionProvider.prototype.getQuestionCollection = function (unit_id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpHeaders */]().set('Content-Type', 'application/json').set('x-access-token', this.token);
        return this.http.get(this.api + ("/unit/" + unit_id + "/question"), { reportProgress: true, observe: 'events', headers: headers }).pipe();
    };
    QuestionProvider.prototype.postAnswerCollection = function (userId, answer) {
        var params = Object.assign(answer);
        var headers = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpHeaders */]().set('Content-Type', 'application/json').set('x-access-token', this.token);
        return this.http.post(this.api + ("/user/" + userId + "/answer"), params, { reportProgress: true, observe: 'events', headers: headers }).pipe();
    };
    QuestionProvider.prototype.getAnswerCollection = function (query) {
        var params = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["d" /* HttpParams */]().set('user_id', query.user_id);
        var headers = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpHeaders */]().set('Content-Type', 'application/json').set('x-access-token', this.token);
        return this.http.get(this.api + "/answer", { params: params, reportProgress: true, observe: 'events', headers: headers }).pipe();
    };
    QuestionProvider.prototype.getAnswerResource = function (question_id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpHeaders */]().set('Content-Type', 'application/json').set('x-access-token', this.token);
        return this.http.get(this.api + ("/question/" + question_id), { reportProgress: true, observe: 'events', headers: headers }).pipe();
    };
